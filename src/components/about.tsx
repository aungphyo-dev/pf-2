  ...
  return (
    <section aria-label='about' id='about'>
      ...
      <p className='mb-5 text-[17px] leading-[30px] tracking-wide text-[#94a3b8]'>
        ...
        am 20 years old web application developer based in Mandalay. I am
        currently part of the talented team at{' '}
        <a
          target='_blank'
          rel='noreferrer'
        ...
        NextJS, Firebase, Supabase, PHP, Laravel, MySql, Postgresql.
      </p>
      <p className='mb-5 text-[17px] leading-[30px] tracking-wide text-[#94a3b8]'>
        I am passionate about crafting seamless and captivating online
        experiences. Beyond my dedication to Web Development, I am driven by my
        love for language and culture. I have embarked on a journey to learn the
        Japanese Language, fascinated by its intricacies and the doors it can
        open to a whole new world of understanding.
      </p>
      <p className='mb-5 text-[17px] leading-[30px] tracking-wide text-[#94a3b8]'>
