const About = () => {
    const paragraph = `Hello, I am Aung Pyae Phyo,I am 20 years old  web application developer based in Mandalay. I am currently part of the talented team at Counter, where I am honing my skills and contributing to innovative web projects with tech stacks that include Javascript, ReactJS, ReactNative, NextJS, Firebase, Supabase, PHP, Laravel, MySql, Postgresql, I am passionate about crafting seamless and captivating online experiences. Beyond my dedication to Web Development, I am driven by my love for language and culture. I have embarked on a journey to learn the Japanese Language, fascinated by its intricacies and the doors it can open to a whole new world of understanding. As a firm believer in lifelong learning, I am excited to expand my horizons and continuously grow both as a developer and a language enthusiast.`
    return (
        <section data-section="" className='w-full bg-transparent relative' id="about">
            <div className='w-full py-0 lg:py-5 flex flex-col justify-start items-start'>
                <div
